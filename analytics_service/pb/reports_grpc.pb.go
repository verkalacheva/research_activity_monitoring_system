...
func (c *analyticsServiceClient) GenerateReport(ctx context.Context, in *ReportRequest, opts ...grpc.CallOption) (*ReportResponse, error) {
	out := new(ReportResponse)
	err := c.cc.Invoke(ctx, "/reports.AnalyticsService/GenerateReport", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAnalyticsServiceServer) GenerateReport(context.Context, *ReportRequest) (*ReportResponse, error) {
...
func _AnalyticsService_GenerateReport_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/reports.AnalyticsService/GenerateReport",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AnalyticsServiceServer).GenerateReport(ctx, req.(*ReportRequest))
	}
...
var AnalyticsService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "reports.AnalyticsService",
