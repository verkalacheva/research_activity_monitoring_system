    ...
    class ReportsController < BaseController
      ...
      def selectors
        report_types = [
          ...
          Reports::DevTeamsReportCommand,
          Reports::DevResearchersReportCommand
        ].map do |cmd|
          {
            id: cmd.id
          }
      ...
      def generate
        ...
        command_class = case p[:report_type]
                        ...
                        when 'dev_teams_report' then Reports::DevTeamsReportCommand
                        when 'dev_researchers_report' then Reports::DevResearchersReportCommand
